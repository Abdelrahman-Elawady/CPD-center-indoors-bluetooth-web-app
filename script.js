...
document.getElementById('connect').addEventListener('click', async () => {
    try {
        device = await navigator.bluetooth.requestDevice({
            ...
            optionalServices: ['d8a07eb5-215a-42c4-8ec4-514e1cdc6b78']
        });
        const server = await device.gatt.connect();
        const service = await server.getPrimaryService('d8a07eb5-215a-42c4-8ec4-514e1cdc6b78');
        characteristic = await service.getCharacteristic('21687baa-dfe1-4f13-bbcc-0a787e9d85a2');
        // Get the notify characteristic
        notifyCharacteristic = await service.getCharacteristic('95b0807e-bdeb-4a9e-b3bc-3e3e757937e9'); // Replace with the actual UUID
